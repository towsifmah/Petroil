            ...
            <div className="flex justify-center flex-wrap md:gap-x-[62px] gap-y-[32px]">
                <div className="bg-card1 bg-center bg-cover bg-no-repeat">
                    <div className="bg-overlay pt-[75px] pb-[55.28px] pl-[46px] pr-[44px]">
                        <h2 className="w-[249px] text-[24px] font-bold font-popping text-white mb-[63px]">lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod.</h2>
                        <a href="" className="py-[10px] px-[22px] bg-[#FFFFFF80] text-white text-[12px] font-popping font-semibold hover:bg-transparent duration-300 hover:border">Read More</a>
                    </div>
                </div>
                ...
                <div className="bg-card3 bg-center bg-cover bg-no-repeat">
                    <div className="bg-overlay pt-[75px] pb-[55.28px] pl-[46px] pr-[44px]">
                        <h2 className="max-w-[249px] text-[24px] font-bold font-popping text-white mb-[63px]">lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod.</h2>
                        <a href="" className="py-[10px] px-[22px] bg-[#FFFFFF80] text-white text-[12px] font-popping font-semibold hover:bg-transparent duration-300 hover:border">Read More</a>
                    </div>
                </div>
            </div>
